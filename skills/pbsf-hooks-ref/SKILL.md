---
name: pbsf-hooks-ref
description: PBSF 项目所有 Hooks 用法速查(useTable/useDict/useBTitle/useBreadcrumb/useCRoute/useActionColumnWidth/useUnsavedChangesGuard/useEventBus)。生成页面时需要正确的 hook 用法时使用。
---
