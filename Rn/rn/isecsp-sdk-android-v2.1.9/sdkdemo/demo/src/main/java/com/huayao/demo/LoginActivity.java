...
import net.vpnsdk.vpn.VPNSdkConstant;
...
public class LoginActivity extends Activity implements OnItemSelectedListener {
    ...
    private EditText mEdtCustomer1;
    ...
    private void loadComponents() {
        ...
        mEdtCustomer1 = (EditText) findViewById(R.id.edtCustomer1MultiLoginVal);
    ...
    public void clickLogin(View view) {
        ...
        VPNSdkConstant.custom1 = mEdtCustomer1.getText().toString();
        int editIndex = 0;
        EditText edt;
        ...
        if(isShowDycodeView){
            ...
            VPNManager.getInstance().getDynamicCode(url, new CommonCallback() {
                ...
                public void result(Object obj, String info) {
                    ...
                    LogUtils.d(LoginActivity.this, TAG, "dynamic code info : " + info);
