...
const GAMES = [
  ...
  { id: "tetris",  ic: "🧱", n: "俄罗斯方块", d: "消行对战",      span: "",   status: "play" },
  { id: "trapcat", ic: "🐱", n: "围住神经猫", d: "六边形围猫",    span: "",   status: "play" },
  { id: "flyer",   ic: "🚀", n: "双人飞行器", d: "空战对决",      span: "w2", status: "play" },
  { id: "quiz",    ic: "💬", n: "默契问答",   d: "测测默契度",    span: "",   status: "play" },
  { id: "memory",  ic: "🃏", n: "记忆配对",   d: "情侣翻牌",      span: "",   status: "play" },
  { id: "synctap", ic: "🎵", n: "心动节拍",   d: "同步点击",      span: "t2", status: "play" },
  { id: "draw",    ic: "🎨", n: "你画我猜",   d: "画给 ta 猜",    span: "w2", status: "play" },
];
