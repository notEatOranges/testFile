...
> 来源：[官方文档](https://uniapp.dcloud.net.cn/tutorial/vue3-api-diff.html)
...
!
**Android/iOS(uni-app x)**](https://hellouniappx.dcloud.net.cn/)[

!
**鸿蒙(uni-app x)** **需使用已升级到鸿蒙Next** **的手机扫码体验**](#)[

!
**Web(uni-app x)**](https://hellouniappx.dcloud.net.cn/web)[
...
!
**Android版(uni-app)**](//m3w.cn/uniapp)[

!
**iOS版(uni-app)**](https://itunes.apple.com/cn/app/hello-uni-app/id1417078253?mt=8)[

!
**鸿蒙(uni-app)** **需使用已升级到鸿蒙Next** **的手机扫码体验**](#)[
...
!
**微信小程序版(uni-app)**](//m3w.cn/uniapp)[

!
**鸿蒙元服务(uni-app)** **需使用已升级到鸿蒙Next** **的手机扫码体验**](//m3w.cn/uniapp)[

!
**支付宝小程序版(uni-app)**](//m3w.cn/uniapp)[
...
!
**抖音小程序版(uni-app)**](//m3w.cn/uniapp)[

!
**360小程序(uni-app)**](https://so.mp.360.cn/mp.html?appid=qh4j181qqtru354st6)[

!
**快手小程序版(uni-app)**](//m3w.cn/uniapp)[
...
!
**钉钉小程序版(uni-app)**](//m3w.cn/uniapp)[

!
**京东小程序版(uni-app)**](//m3w.cn/uniapp)[

!
**小红书小程序版(uni-app)**](//m3w.cn/uniapp)[
...
!
**QQ小程序版(uni-app)**
注： _\- 某些平台不能提交简单demo，故补充了一些其他功能；hello uni-app示例代码可从 [github](https://github.com/dcloudio/hello-uniapp) 获取_ _\- 快应用仅支持 vivo 、oppo、华为_ _\- 360小程序仅 windows平台支持，需要在360浏览器中打开_ _\- uni-app 已支持纯血鸿蒙开发，详见 [鸿蒙开发专题](https://uniapp.dcloud.net.cn/tutorial/harmony/dev.html)。_
...
[插件市场](https://ext.dcloud.net.cn/?orderBy=WeekDownload)数千款插件。
